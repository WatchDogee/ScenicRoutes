...
class PointOfInterestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $poi->name = $data['name'];
        $poi->type = $data['type'];
        $poi->subtype = $data['subtype'];
        $poi->latitude = $data['latitude'];
        $poi->longitude = $data['longitude'];
        $poi->description = $data['description'] ?? null;
        $poi->properties = $data['properties'] ?? null;
        $poi->is_verified = false;
        $poi->save();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($poi->user_id !== Auth::id() && !Auth::user()->hasRole('admin')) {
