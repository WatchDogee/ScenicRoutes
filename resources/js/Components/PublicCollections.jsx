...
export default function PublicCollections({ onViewCollection, onViewUser }) {
    ...
    const fetchCollectionsByCountry = async (country) => {
        try {
            ...
            console.error('Error fetching collections by country:', error);
    ...
    const handleCountryChange = (e) => {
        ...
        setSelectedTag(''); // Reset tag when country changes
    };

    const handleTagChange = (e) => {
        setSelectedTag(e.target.value);
        setSelectedCountry(''); // Reset country when tag changes
    };
