...
export default function SaveToCollectionModal({
    ...
    const fetchCollections = async () => {
        try {
            ...
            const collectionsData = response.data.data || response.data.collections || response.data;
    ...
    const handleAddToCollection = async () => {
        if (!selectedCollectionId) {
            showToast('Please select a collection', 'warning', 3000);
            return;
        }
        try {
            ...
            // Refetch collections to update the road counts
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-3">
                                                    ...
                                                    <p className="text-xs text-gray-600">
                                                        {collection.roads_count ?? collection.roads?.length ?? 0} roads • {collection.is_public ? 'Public' : 'Private'}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
