            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                {validPhotoArray.map((photo, idx) => (
                    ...
                    >
                        ...
                        {canDelete && (
                            <button
                                className="absolute top-1 right-1 bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center opacity-90 hover:opacity-100 shadow-md z-10 transition-opacity duration-200"
                                onClick={(e) => {
                                    e.stopPropagation();
