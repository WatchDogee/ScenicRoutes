...
/**
 * TagSelectorModal component for selecting predefined tags
 *
 * @param {Object} props
 ...
 * @param {Function} props.onTagsChange - Callback when tags are changed
...
export default function TagSelectorModal({
    ...
    useEffect(() => {
        const fetchTags = async () => {
            try {
                console.log('TagSelectorModal: Fetching tags...');
                setLoading(true);
                const response = await axios.get('/api/tags');
                console.log('TagSelectorModal: Tags fetched successfully:', response.data);
        ...
        if (isOpen) {
            console.log('TagSelectorModal: Modal is open, initializing...');
            fetchTags();
        }
    }, [isOpen]);
    ...
    const handleTagSelect = (tag) => {
        ...
        if (isTagSelected(tag.id)) {
            ...
            console.log('Removing tag, new tags:', updatedTags);
            onTagsChange(updatedTags);
        } else {
            // Add tag if not already selected
            const updatedTags = [...selectedTags, tag];
            console.log('Adding tag, new tags:', updatedTags);
            onTagsChange(updatedTags);
        }
    };

    if (!isOpen) {
        console.log('TagSelectorModal: Not rendering because isOpen is false');
        return null;
    }

    console.log('TagSelectorModal: Rendering modal, isOpen =', isOpen);
    return (
