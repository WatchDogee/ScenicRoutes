...
/**
 * Test component for weather integration
 */
const WeatherTest = () => {
    const [weather, setWeather] = useState(null);
    const [loading, setLoading] = useState(true);
    const [error, setError] = useState(null);
    const [coordinates, setCoordinates] = useState({ lat: 56.9496, lon: 24.1052 }); // Default coordinates (Riga, Latvia)
        ...
        const fetchWeather = async () => {
            ...
            try {
                ...
                if (weatherData && weatherData.error) {
                    ...
                    console.log('Weather service returned error:', weatherData.error);
                    if (weatherData.error === 'api_key_invalid') {
                        // Don't set error state, just pass the error object to the weather state
