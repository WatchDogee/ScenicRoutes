...
return [
    ...
    */
    ...
    'graphhopper' => [
        'url' => env('GRAPHHOPPER_URL', 'http://localhost:8989'),
        'profile' => env('GRAPHHOPPER_PROFILE', 'car'),
        // Try a secondary env var name in case the original has hidden characters
        'api_key' => env('GRAPHHOPPER_WEB_API_KEY', env('GRAPHHOPPER_API_KEY', null)),
    ],
